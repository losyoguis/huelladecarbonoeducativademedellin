#!/usr/bin/env python3
"""Valida la coherencia e integridad de los históricos de SiMeCO₂ v56."""
...
def main() -> int:
    ...
    if blank_sites:
        errors.append(f"Hay {blank_sites} registros sin nombre de sede.")
    ...
    lines = [
        "CONTROL DE CALIDAD DE HISTÓRICOS — SiMeCO₂ v88",
        ...
        f"Sedes sin nombre: {blank_sites}",
        "",
    ...
    report = "\n".join(lines) + "\n"
    (ROOT / "CONTROL-CALIDAD-HISTORICOS-v56.txt").write_text(report, encoding="utf-8")
    print(report)
