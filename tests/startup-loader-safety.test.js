...
const compact=fs.readFileSync('data/registros.compact.js','utf8');
...
ok(app.includes("setTimeout(()=>{") && app.includes("},3500);"),'Falta timeout de seguridad');
...
ok(html.includes('app.js?v=86-carga-inicial'),'Falta cache-busting v86');
