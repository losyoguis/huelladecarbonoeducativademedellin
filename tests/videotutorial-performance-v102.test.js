...
ok(html.includes('data/registros.electricidad.min.js?v=114-fixed-backend" as="script" fetchpriority="high"'),'Bundle eléctrico no tiene prioridad alta');
ok(html.includes('data/resumenes.electricidad.min.js?v=114-fixed-backend" as="script" fetchpriority="high"'),'Resumen eléctrico no tiene prioridad alta');
ok(html.includes('<script src="data/registros.electricidad.min.js?v=114-fixed-backend" fetchpriority="high"></script>'),'Script eléctrico no tiene prioridad alta');
ok(html.includes('<script defer src="app.js?v=114-fixed-backend" fetchpriority="high"></script>'),'app.js no tiene prioridad alta');
