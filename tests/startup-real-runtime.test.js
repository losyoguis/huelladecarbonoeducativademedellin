...
ok(html.indexOf('data/registros.electricidad.min.js?v=110-document-buttons') < html.indexOf('app.js?v=110-document-buttons'),'Los datos no cargan antes de app.js');
