...
ok(html.indexOf('data/registros.electricidad.min.js?v=96-menu-google-sites') < html.indexOf('app.js?v=96-menu-google-sites'),'Los datos no cargan antes de app.js');
