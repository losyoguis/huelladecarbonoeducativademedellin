...
ok(html.indexOf('data/registros.electricidad.min.js?v=105-inem-electricidad') < html.indexOf('app.js?v=105-inem-electricidad'),'Los datos no cargan antes de app.js');
