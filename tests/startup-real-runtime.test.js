...
ok(html.indexOf('data/registros.electricidad.min.js?v=89-control-calidad') < html.indexOf('app.js?v=90-ranking-co2-columna'),'Los datos no cargan antes de app.js');
