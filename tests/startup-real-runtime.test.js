...
ok(html.indexOf('data/registros.electricidad.min.js?v=88-arranque-inmediato') < html.indexOf('app.js?v=88-arranque-inmediato'),'Los datos no cargan antes de app.js');
