...
ok(html.indexOf('data/registros.electricidad.min.js?v=109-documents-email') < html.indexOf('app.js?v=109-documents-email'),'Los datos no cargan antes de app.js');
