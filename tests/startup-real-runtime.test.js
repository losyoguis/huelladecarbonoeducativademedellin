...
ok(html.indexOf('data/registros.electricidad.min.js?v=95-identidad-graficos') < html.indexOf('app.js?v=95-identidad-graficos'),'Los datos no cargan antes de app.js');
