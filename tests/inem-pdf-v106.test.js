...
const basePos=html.indexOf('data/registros.electricidad.min.js?v=107-light');
const overlayPos=html.indexOf('data/inem/registros.inem.js?v=107-light');
const appPos=html.indexOf('app.js?v=107-light');
