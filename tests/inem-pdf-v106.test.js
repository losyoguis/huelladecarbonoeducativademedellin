...
const basePos=html.indexOf('data/registros.electricidad.min.js?v=106-inem-pdf');
const overlayPos=html.indexOf('data/inem/registros.inem.js?v=106-inem-pdf');
const appPos=html.indexOf('app.js?v=106-inem-pdf');
