...
ok(html.includes('styles.css?v=96-menu-google-sites'),'Falta cache-busting CSS v75');
ok(html.includes('app.js?v=96-menu-google-sites'),'Falta cache-busting JS v75');
