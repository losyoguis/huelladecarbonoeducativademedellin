...
ok(html.includes('styles.css?v=88-arranque-inmediato'),'Falta cache-busting CSS v75');
ok(html.includes('app.js?v=88-arranque-inmediato'),'Falta cache-busting JS v75');
