...
ok(html.includes('styles.css?v=85-electricidad-ranking-co2-pdf'),'Falta cache-busting CSS v75');
ok(html.includes('app.js?v=85-electricidad-ranking-co2-pdf'),'Falta cache-busting JS v75');
