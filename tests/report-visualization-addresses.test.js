...
ok(html.includes('styles.css?v=81-ranking-seccion-plan-accion'),'Falta cache-busting CSS v75');
ok(html.includes('app.js?v=81-ranking-seccion-plan-accion'),'Falta cache-busting JS v75');
