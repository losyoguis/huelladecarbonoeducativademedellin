...
ok(html.includes('styles.css?v=110-document-buttons'),'Falta cache-busting CSS v75');
ok(html.includes('app.js?v=110-document-buttons'),'Falta cache-busting JS v75');
