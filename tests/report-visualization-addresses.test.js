...
ok(html.includes('styles.css?v=95-identidad-graficos'),'Falta cache-busting CSS v75');
ok(html.includes('app.js?v=95-identidad-graficos'),'Falta cache-busting JS v75');
