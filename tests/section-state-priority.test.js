...
ok(html.includes('id="seccion-6" data-resource="electricidad" data-page-title="Electricidad · Estado de la información"'),'Falta contenedor eléctrico sección 6');
ok(html.includes('id="seccion-7" data-resource="electricidad" data-page-title="Electricidad · Aula"'),'Falta contenedor eléctrico sección 7');
...
ok(css.includes('.section-switcher{grid-template-columns:repeat(5,minmax(0,1fr))}'),'Navegación principal no soporta 9 módulos');
