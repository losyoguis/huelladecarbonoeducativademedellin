...
ok(html.includes('styles.css?v=90-ranking-co2-columna'),'Falta cache-busting CSS v79');
ok(html.includes('app.js?v=90-ranking-co2-columna'),'Falta cache-busting JS v79');
