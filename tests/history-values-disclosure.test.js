...
ok(html.includes('styles.css?v=79-historico-desplegable'),'Falta cache-busting CSS v79');
ok(html.includes('app.js?v=79-historico-desplegable'),'Falta cache-busting JS v79');
