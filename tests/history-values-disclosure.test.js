...
ok(html.includes('styles.css?v=105-inem-electricidad'),'Falta cache-busting CSS v79');
ok(html.includes('app.js?v=105-inem-electricidad'),'Falta cache-busting JS v79');
