...
ok(html.includes('styles.css?v=105-inem-electricidad'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=105-inem-electricidad'),'No se actualizó cache-busting JS');
