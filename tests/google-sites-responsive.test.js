...
ok(html.includes('styles.css?v=85-electricidad-ranking-co2-pdf'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=85-electricidad-ranking-co2-pdf'),'No se actualizó cache-busting JS');
