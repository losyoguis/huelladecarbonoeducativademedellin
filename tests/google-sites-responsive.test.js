...
ok(html.includes('styles.css?v=104-video-segundo-0'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=104-video-segundo-0'),'No se actualizó cache-busting JS');
