...
ok(html.includes('styles.css?v=82-estado-prioridad'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=82-estado-prioridad'),'No se actualizó cache-busting JS');
