...
ok(html.includes('styles.css?v=114-fixed-backend'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=114-fixed-backend'),'No se actualizó cache-busting JS');
