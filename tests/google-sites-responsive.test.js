...
ok(html.includes('styles.css?v=78-sede-prioritaria'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=78-sede-prioritaria'),'No se actualizó cache-busting JS');
