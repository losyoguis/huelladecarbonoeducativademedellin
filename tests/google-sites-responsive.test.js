...
ok(html.includes('styles.css?v=91-historico-pdf'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=91-historico-pdf'),'No se actualizó cache-busting JS');
