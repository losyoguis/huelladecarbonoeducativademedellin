...
ok(html.includes('styles.css?v=75-informe-visual'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=75-informe-visual'),'No se actualizó cache-busting JS');
