...
ok(html.includes('styles.css?v=110-document-buttons'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=110-document-buttons'),'No se actualizó cache-busting JS');
