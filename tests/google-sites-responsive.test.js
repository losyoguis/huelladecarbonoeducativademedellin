...
ok(html.includes('styles.css?v=109-documents-email'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=109-documents-email'),'No se actualizó cache-busting JS');
