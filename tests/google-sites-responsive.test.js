...
ok(html.includes('styles.css?v=96-menu-google-sites'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=96-menu-google-sites'),'No se actualizó cache-busting JS');
