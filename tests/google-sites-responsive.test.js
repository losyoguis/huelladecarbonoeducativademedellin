...
ok(html.includes('styles.css?v=74-google-sites-responsive'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=74-google-sites-responsive'),'No se actualizó cache-busting JS');
