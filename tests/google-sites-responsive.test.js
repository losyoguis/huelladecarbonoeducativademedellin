...
ok(html.includes('styles.css?v=87-datos-rapidos'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=87-datos-rapidos'),'No se actualizó cache-busting JS');
