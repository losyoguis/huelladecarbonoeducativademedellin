...
ok(html.includes('styles.css?v=76-informe-interactivo'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=76-informe-interactivo'),'No se actualizó cache-busting JS');
