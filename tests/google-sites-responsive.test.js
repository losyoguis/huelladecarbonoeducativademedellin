...
ok(html.includes('styles.css?v=98-sidebar-legible'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=98-sidebar-legible'),'No se actualizó cache-busting JS');
