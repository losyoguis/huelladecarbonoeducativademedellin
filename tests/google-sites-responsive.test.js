...
ok(html.includes('styles.css?v=95-identidad-graficos'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=95-identidad-graficos'),'No se actualizó cache-busting JS');
