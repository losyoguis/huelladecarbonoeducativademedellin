...
ok(html.includes('styles.css?v=90-ranking-co2-columna'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=90-ranking-co2-columna'),'No se actualizó cache-busting JS');
