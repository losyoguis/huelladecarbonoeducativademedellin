...
ok(html.includes('styles.css?v=77-historico-ni'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=77-historico-ni'),'No se actualizó cache-busting JS');
