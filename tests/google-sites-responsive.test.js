...
ok(html.includes('styles.css?v=79-historico-desplegable'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=79-historico-desplegable'),'No se actualizó cache-busting JS');
