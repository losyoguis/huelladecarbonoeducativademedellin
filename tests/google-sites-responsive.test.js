...
ok(html.includes('styles.css?v=108-action-plan'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=108-action-plan'),'No se actualizó cache-busting JS');
