...
ok(html.includes('styles.css?v=86-carga-inicial'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=86-carga-inicial'),'No se actualizó cache-busting JS');
