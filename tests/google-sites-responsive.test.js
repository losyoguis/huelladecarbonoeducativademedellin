...
ok(html.includes('styles.css?v=81-ranking-seccion-plan-accion'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=81-ranking-seccion-plan-accion'),'No se actualizó cache-busting JS');
