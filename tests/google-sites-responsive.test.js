...
ok(html.includes('styles.css?v=103-primera-visita'),'No se actualizó cache-busting CSS');
ok(html.includes('app.js?v=103-primera-visita'),'No se actualizó cache-busting JS');
