...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=107-light');
const appPos=html.indexOf('app.js?v=107-light');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=107-light"'),'Falta preload del bundle');
