...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=93-agua');
const appPos=html.indexOf('app.js?v=93-agua');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=93-agua"'),'Falta preload del bundle');
