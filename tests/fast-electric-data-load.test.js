...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=106-inem-pdf');
const appPos=html.indexOf('app.js?v=106-inem-pdf');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=106-inem-pdf"'),'Falta preload del bundle');
