...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=88-arranque-inmediato');
const appPos=html.indexOf('app.js?v=88-arranque-inmediato');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=88-arranque-inmediato"'),'Falta preload del bundle');
