...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=100-ux-organizada');
const appPos=html.indexOf('app.js?v=100-ux-organizada');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=100-ux-organizada"'),'Falta preload del bundle');
