...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=95-identidad-graficos');
const appPos=html.indexOf('app.js?v=95-identidad-graficos');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=95-identidad-graficos"'),'Falta preload del bundle');
