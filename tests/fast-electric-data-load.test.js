...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=98-sidebar-legible');
const appPos=html.indexOf('app.js?v=98-sidebar-legible');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=98-sidebar-legible"'),'Falta preload del bundle');
