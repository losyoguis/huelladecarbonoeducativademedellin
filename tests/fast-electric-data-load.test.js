...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=108-action-plan');
...
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=108-action-plan"'),'Falta preload del bundle');
