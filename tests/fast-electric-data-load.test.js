...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=110-document-buttons');
...
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=110-document-buttons"'),'Falta preload del bundle');
