...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=99-activo-visible');
const appPos=html.indexOf('app.js?v=99-activo-visible');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=99-activo-visible"'),'Falta preload del bundle');
