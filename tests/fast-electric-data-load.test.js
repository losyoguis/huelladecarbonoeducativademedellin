...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=101-menu-tarjetas');
const appPos=html.indexOf('app.js?v=101-menu-tarjetas');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=101-menu-tarjetas"'),'Falta preload del bundle');
