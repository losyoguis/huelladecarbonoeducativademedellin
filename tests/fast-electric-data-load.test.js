...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=104-video-segundo-0');
const appPos=html.indexOf('app.js?v=104-video-segundo-0');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=104-video-segundo-0"'),'Falta preload del bundle');
