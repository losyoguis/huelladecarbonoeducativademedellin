...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=105-inem-electricidad');
const appPos=html.indexOf('app.js?v=105-inem-electricidad');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=105-inem-electricidad"'),'Falta preload del bundle');
