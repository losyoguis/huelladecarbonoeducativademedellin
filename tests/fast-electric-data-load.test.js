...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=96-menu-google-sites');
const appPos=html.indexOf('app.js?v=96-menu-google-sites');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=96-menu-google-sites"'),'Falta preload del bundle');
