...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=103-primera-visita');
const appPos=html.indexOf('app.js?v=103-primera-visita');
ok(dataPos>=0 && appPos>dataPos,'El bundle eléctrico no carga antes de app.js');
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=103-primera-visita"'),'Falta preload del bundle');
