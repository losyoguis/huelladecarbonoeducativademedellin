...
const dataPos=html.indexOf('data/registros.electricidad.min.js?v=109-documents-email');
...
ok(html.includes('rel="preload" href="data/registros.electricidad.min.js?v=109-documents-email"'),'Falta preload del bundle');
