...
ok(app.includes("const DATA_VERSION = 'v100-ux-interface-organizada-20260808';"),'DATA_VERSION no es v100');
ok(html.includes('app.js?v=100-ux-organizada'),'Cache-busting v100 ausente');
