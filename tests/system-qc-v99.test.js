...
ok(app.includes("const DATA_VERSION = 'v99-activo-visible-mobile-app-20260808';"),'DATA_VERSION no es v99');
ok(html.includes('app.js?v=99-activo-visible'),'Cache-busting v99 ausente');
